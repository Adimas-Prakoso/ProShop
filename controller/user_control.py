...
class UserMainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.mini_btn_order.clicked.connect(lambda: self.show_order())
        ...
        self.ui.big_btn_order.clicked.connect(lambda: self.show_order())
    ...
    def show_order(self):
        self.ui.stackedWidget.setCurrentWidget(self.ui.being_packed)
